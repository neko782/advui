...
<style>
  ...
  .chat-list { display: grid; gap: 6px; padding: 0 8px 10px; overflow: auto; }
  .chat-item { text-align: left; display: grid; gap: 2px; padding: 8px 10px; border-radius: 10px; border: 1px solid var(--border); background: var(--panel); color: var(--text); font: inherit; }
  .chat-item.active { outline: 2px solid #3584e4; outline-offset: 0; }
