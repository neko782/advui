<script lang="ts">
  ...
  function inferMimeType(file) {
    ...
    if (typeof file.name === 'string' && file.name) {
      ...
      // Text and code types
      if (lower.endsWith('.txt') || lower.endsWith('.text') || lower.endsWith('.log')) return 'text/plain'
      ...
      if (lower.endsWith('.cpp') || lower.endsWith('.cc') || lower.endsWith('.cxx') || lower.endsWith('.hh')) return 'text/x-c++'
      if (lower.endsWith('.cs')) return 'text/x-csharp'
      if (lower.endsWith('.swift')) return 'text/x-swift'
      if (lower.endsWith('.kt')) return 'text/x-kotlin'
      if (lower.endsWith('.php')) return 'text/x-php'
      if (lower.endsWith('.sh') || lower.endsWith('.bash') || lower.endsWith('.zsh')) return 'text/x-sh'
      if (lower.endsWith('.sql')) return 'application/x-sql'
      if (lower.endsWith('.r')) return 'text/x-r'
      if (lower.endsWith('.pl')) return 'text/x-perl'
      if (lower.endsWith('.lua')) return 'text/x-lua'
      if (lower.endsWith('.jsx')) return 'text/jsx'
      if (lower.endsWith('.vue') || lower.endsWith('.svelte')) return 'text/plain'
      if (lower.endsWith('.rst')) return 'text/x-rst'
      if (lower.endsWith('.tex')) return 'text/x-tex'
      if (lower.endsWith('.srt')) return 'text/srt'
